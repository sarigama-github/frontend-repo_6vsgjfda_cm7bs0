export default function Products() {
  return (
    <section className="relative py-16 bg-slate-950/40">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <a href="https://jamartech.ai" target="_blank" rel="noreferrer" className="group rounded-2xl border border-white/10 bg-white/5 hover:bg-white/10 transition-colors p-6 flex flex-col">
